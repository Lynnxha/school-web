					...
					<div class="card-body">
						<form method="POST" action="proses_tambah.php" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col">
									<div class="form-group">
										<label for="mata_pelajaran">Jabatan</label>
										<input type="text" class="form-control" id="mata_pelajaran" placeholder="Jabatan" autocomplete="off" required="required" name="jabatan">
									</div>
								</div>
							</div>
							<div class="form-group">
