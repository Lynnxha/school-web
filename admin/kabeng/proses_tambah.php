...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		...
		$query = mysqli_query($koneksi, "INSERT INTO tbl_kabeng (nama, nip, jenis_kelamin, no_hp, jabatan, foto) VALUES('$nama', $nip, '$jenis_kelamin', '$no_hp', '$jabatan', '$nama_foto')") or die(mysqli_error($koneksi));
